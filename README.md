...
The core logic is in ChangeProcessor.ts to allow for modularity. If requirements change this allows for easy porting to a new application, whether a mobile app, or CLI, or any other platform.
